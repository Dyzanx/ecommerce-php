...
<a class="button button-small" href="<?=base_url?>?controller=product&action=create">Crear nuevo producto</a>
...
<table>
    ...
    <tr>
        ...
        <?php endif; ?>
        <td>
            <a href="<?=base_url?>?controller=product&action=edit&id=<?=$prod->id?>"><i class="fa-solid fa-pen-to-square table-icon button"></i></a>
            <a href="<?=base_url?>?controller=product&action=delete&id=<?=$prod->id?>"><i class="fa-solid fa-trash table-icon button button-red"></i></a>
        </td>
    </tr>
    <?php endwhile; ?> 
</table>