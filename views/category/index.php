...
<a href="<?= base_url ?>category/create" class="button button-small">Crear nuevas categorias</a>
...
<table>
    ...
    <?php while ($cat = $categories->fetch_object()) : ?>
        <tr>
            <td><?= $cat->id ?></td>
            <td><?= $cat->name ?></td>
            <td><a href="<?= base_url ?>category/delete&id=<?= $cat->id ?>"><i class="fa-solid fa-trash table-icon button button-red"></i></a></td>
        </tr>
    <?php endwhile; ?>
</table>