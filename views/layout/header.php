    ...
    <div class="container">
        ...
        <header class="header">
            <div class="logo">
                ...
                <a href="<?=base_url?>?controller=product&action=index">
                    Tienda de camisetas
                </a>
            </div>
        </header>
        ...
        <nav class="menu">
            <ul>
                <li><a href="<?=base_url?>?controller=product&action=index">Inicio</a></li>
                <?php 
                    $categories = utils::getCategories(); 
                    while($cat = $categories->fetch_object()):
                ?>
                <li><a href="<?=base_url?>?controller=category&action=show&id=<?=$cat->id?>"><?= $cat->name ?></a></li>
                <?php endwhile; ?>
            </ul>
        </nav>
